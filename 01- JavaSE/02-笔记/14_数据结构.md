...
>自平衡的二叉搜索树存在的意义?
>
>- 为了解决, 普通二叉搜索树, 在不断的添加和删除过程中, 变成稀疏树, 导致添加/删除/查找效率降低的问题.
>- 自平衡的二叉搜索树, 不会让树, 变成稀疏树
>
...
>自平衡的二叉搜索树的缺陷? 
>
>- 因为自平衡二叉搜索树平衡要求很严格(平衡性能比较好), 导致了我们要在自平衡的二叉搜索树中操作添加一个/删除一个结点,  会导致不相邻的结点变得不平衡, 如果我们要在这种情况下, 要保证平衡/处理这个不平衡的非相邻结点,    这是非局部性操作(导致操作变得复杂), 所以在实际工作中基本上没有人使用自平衡的二叉搜索树
>
>
>
>## 多路查找树
...
>
>![image-20231222201900219](数据结构 -改.assets/image-20231222201900219.png)
>
>
>
>### 2-3-4树
